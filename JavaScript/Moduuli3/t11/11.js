...
// elements that contain heading, image, image caption and text and populate
// them with the data from picArray. Add the articles to the <section>
// element. (5p)
...
document.querySelectorAll('.card').forEach((article, index) => {
    article.addEventListener('click', function () {
        ...
        modal.showModal();
        const x_button = document.querySelector('span');
        x_button.addEventListener("mouseover", function() {
            x_button.style.cursor = 'pointer'});
        x_button.addEventListener("click", function (evt){
            modal.close()});
    });
});