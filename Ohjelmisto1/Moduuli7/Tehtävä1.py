...
if 1 <= month_num <= 12:
    if month_num == 12 or month_num == 1 or month_num == 2:
        # Jos kuukauden numero on 12 1 tai 2 niin kuukauden i on 0 \
        # jolloin se on automaattisesti talvi, tämän if lausekkeen voi korjata myös sijoittamalla seasons listaan 5. talvi
        season = 0
    else:
